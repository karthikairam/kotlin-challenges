package com.rk.learnkotlin.learnkotlin.challenge2
...
fun main() {
    ...
    val shortNumbers1 = shortArrayOf(1, 2, 3, 4, 5) // Primitive ShortArray class
    val shortNumbers2: Array<Short> = arrayOf(1, 2, 3, 4, 5) // Generic class Array<Short>
    val shortNumbers3 = Array<Short>(5) { i -> (i + 1).toShort() } // Same as above
    ...
    val nullableIntNumbers = Array<Int?>(40) {i -> (i + 1) * 5}
